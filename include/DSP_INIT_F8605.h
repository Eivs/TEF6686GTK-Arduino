#ifndef DSP_INIT_F8605_H
#define DSP_INIT_F8605_H
//  v205_p512
static const uint8_t DSP_INIT_F8605[] PROGMEM = {
    ...
    0x03, 0x1C, 0x00, 0x00,                                     // Clear Required Initialization Control
    0x03, 0x14, 0x00, 0x01,                                     // ‘Start’ brings the device into ‘idle state’
    0x02, 0xFF, 50,                                             // Wait 50 mS
    0x09, 0x40, 0x04, 0x01, 0x00, 0x3D, 0x09, 0x00, 0x00, 0x00, // 4000 kHz crystal reference
    // 0x09, 0x40, 0x04, 0x01, 0x00, 0x8C, 0xA0, 0x00, 0x00, 0x00, // 9216 kHz crystal reference
    0x05, 0x40, 0x05, 0x01, 0x00, 0x01, // APPL_Activate brings the device into ‘active state’ = radio standby
    ...
    0x05, 0x20, 0x20, 0x01, 0x00, 0x00,                                                                         // FM_Set_StereoImprovement         (1, 0) - available for TEF6687 and TEF6689 only !
    0x07, 0x20, 0x21, 0x01, 0x00, 0x01, 0x3A, 0x98,                                                             // FM Set_Highcut_Fix               (1, 1, 15000)
    0x07, 0x20, 0x22, 0x01, 0x00, 0x01, 0x00, 0x1E,                                                             // FM_Set_Lowcut_Fix                (1, 1, 30)
    ...
    0x07, 0x20, 0x2D, 0x01, 0000, 0x01, 0x00, 0x3C,                                                             // FM 45 Set_Softmute_Max           (1, 1, 60)
    ...
    0x07, 0x20, 0x37, 0x01, 0x00, 0x01, 0x1B, 0x58,                                                             // FM 55 Set_HighCut_Max            (1, 1, 7000)
    0x07, 0x20, 0x38, 0x01, 0x00, 0x01, 0x3A, 0x98,                                                             // FM 56 Set_Highcut_Min            (1, 1, 15000)
    0x07, 0x20, 0x39, 0x01, 0x00, 0x01, 0x00, 0x3C,                                                             // FM 57 Set_Lowcut_Max             (1, 1, 60)
    ...
    0x05, 0x20, 0x56, 0x01, 0x03, 0xB6,                                                                         // FM_86 Set_Bandwidth_Options      (1, 950)  Default
    ...
    // 0x05, 0x20, 0x80, 0x01, 0x00, 0x00,                                                                          // FM_Get_Quality_Status
    // 0x05, 0x20, 0x81, 0x01, 0x00, 0x01,                                                                          // FM_Get_Quality_Data
    ...
    // 0x09, 0x40, 0x03, 0x01, 0x00, 0x02, 0x00, 0x20, 0x01, 0x06,              // APPL_Set_GPIO (1, 2, 32, 262) DAVN @ GPIO 2 for FM RF Ext. AGC
    0x00};
